...
public class SmsDataSerializerTest {
    ...
    public void sessionMessageDataSuccess() throws ParseException {
        ...
        var date = Instant.ofEpochMilli(701953759344326016L);
        var date_read = Instant.ofEpochMilli(701953934692792192L);
        var guid = UUID.fromString("A6EF7781-F25E-0351-8847-140D0810A973");
        var handle_id = 934;
        var has_dd_results = true;
        var is_deleted = false;
        var is_from_me = false;
        SimpleDateFormat df = new SimpleDateFormat(InstantTypeAdapter.DATE_PATTERN);
        var send_date = parseString2Instant("03-31-2023 14:09:19", InstantTypeAdapter.UTC_ZONE, InstantTypeAdapter.DATE_PATTERN);
        var send_status = 0;
        var service = "SMS";
